...
<template>
  <div class="service-order-list">
    ...
    <table class="service-order-list__list">
      <tr class="service-order-list__item" v-for="el in [1,2,3,4,5]" :key="el" @click="openServiceOrder(el)">
        <td style="width: 100%; display: flex; justify-content: flex-end; padding: 8px;">
        ...
        <td class="table-field">
          ...
          <span class="table-field__value"> 0/0 </span>
        </td>
        <td class="table-field">
          <span class="table-field__name">Название</span>
          <span class="table-field__value">С ЛС Пушкино(065)</span>
        </td>
        <td class="table-field">
          <span class="table-field__name">Id заявки</span>
          <span class="table-field__value">1915</span>
        </td>
        <td class="table-field">
        ...
        <td class="table-field">
          ...
          <span class="table-field__value">26.03.2023</span>
        </td>
        <td class="table-field">
